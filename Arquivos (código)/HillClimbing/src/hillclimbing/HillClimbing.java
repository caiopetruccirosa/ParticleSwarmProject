...
public class HillClimbing {
        ...
        public static void main(String[] args) {
        	...
        	gerarGraficos(); // gera os gráficos da função e de convergência dos fatores
        }
        
		public static void buscarMaximo() { // função que realiza o processo de Hill Climbing buscando o valor máximo da função										  
